...
public class Login extends javax.swing.JFrame {
    ...
    private static final String SERVER_IP = "localhost"; //localhost   //26.246.206.48
    ...
    public Login() {
        ...
        SlidePanel = new javax.swing.JPanel() {
            ...
            protected void paintComponent(java.awt.Graphics g) {
                ...
                g2.setColor(new java.awt.Color(255, 255, 255, 45));
                g2.setStroke(new java.awt.BasicStroke(1.5f)); // Tăng độ dày nét 
                ...
                // Vẽ thêm một lớp vòng tròn rộng hơn một chút nhưng mờ hơn (Alpha = 15) 
                g2.setColor(new java.awt.Color(255, 255, 255, 15));
                g2.setStroke(new java.awt.BasicStroke(1f));
                g2.drawOval(-35, -35, 130, 130);
                g2.drawOval(getWidth() - 90, getHeight() - 90, 160, 160);
                g2.drawOval(getWidth() - 60, 3, 110, 110);
                g2.drawOval(0, getHeight() - 70, 110, 110);

                // Thêm một đường chỉ mờ màu trắng nhẹ ở lề phải để cắt khối sắc nét với Form đăng nhập
