...
public class Table extends javax.swing.JFrame {
     ...
     */
    public Table(ObjectInputStream in, ObjectOutputStream out) {
        this.in = in;
        this.out = out;
        initComponents();
        try {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            tbf.setName(JOptionPane.showInputDialog(this, "Nhập tên bàn"));
            tbf.setStatus("Trống");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int row = jTable2.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "vui lòng chọn bàn cần mở");
        } else {
            try {
                int id = Integer.parseInt(jTable2.getValueAt(row, 0).toString());
                ...
                TableFood tbf = new TableFood();
                tbf.setId(id);
                Request req = new Request("OPEN TABLE", tbf);
                out.writeObject(req);
                out.flush();
