...
public class InventoryGui extends javax.swing.JPanel {
    ...
    public InventoryGui() {
        ...
        jList1.setFixedCellHeight(48);
        jList1.setCellRenderer(new DefaultListCellRenderer() {

            private final ImageIcon categoryIcon = new ImageIcon("src/Icon/coffee-menu (3).png");
            ...
            public Component getListCellRendererComponent(
                ...
                if (isSelected) {
                    label.setBackground(new java.awt.Color(0x5C2E0E));
                    label.setForeground(java.awt.Color.WHITE);
                } else {
                    label.setBackground(new java.awt.Color(0xFDF5ED));
                    label.setForeground(new java.awt.Color(0x3B1A08));
                }
    ...
    private void initComponents() {
        ...
        LeftPanel.setBackground(new java.awt.Color(253, 245, 237));
        ...
        LeftPanel.setPreferredSize(new java.awt.Dimension(250, 600));
        ...
        jScrollPane2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(216, 154, 43), 2, true));
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 15, 0, 15));
        ...
        try {
            ...
            if (res != null && "SUCCESS".equals(res.getStatus())) {
                ...
                if (imageBytes != null && imageBytes.length > 0) {
                    ...
                    Image scaled = img.getScaledInstance(jLabel4.getWidth(), jLabel4.getHeight(), Image.SCALE_SMOOTH);
                    jLabel4.setIcon(new ImageIcon(scaled));
                    jLabel4.setText("");
                    jLabel4.setBorder(BorderFactory.createLineBorder(new Color(216, 154, 43), 2, true));
                    jLabel4.revalidate();
                    jLabel4.repaint();
                } else {
                    setNoImage();
