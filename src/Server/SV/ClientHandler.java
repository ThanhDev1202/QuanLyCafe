...
case "UPLOAD IMAGE": {
    try {
        ...
        String fileName = System.currentTimeMillis() + "_" + food.getImagePath();
        ...
        // Lưu đường dẫn tuyệt đối vào Database
        boolean check = fd.updateFoodImage(
                food.getId(),
...
case "SHOW IMAGE": {
    ...
    break;
            ...
            case "GET FOOD FREQ": {
                ...
                List<BillInfor> list = bid.getFoodFrequency();
